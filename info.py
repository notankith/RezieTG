...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>ExaBots|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n🖥 <i>Request Group</i> - ||@MoviesExa|| ')
